...
class TSModel: public GeneralModel {
	...
	public:
		 ...
		 *
		 */
		virtual void gammasolver_initialize(GeneralSolver **gammasolver){
				*gammasolver = NULL;
		};
		 ...
		 *
		 */
		virtual void thetasolver_initialize(GeneralSolver **thetasolver){
				*thetasolver = NULL;
		};
		 ...
		 *
		 */
		virtual void gammasolver_finalize(GeneralSolver **gammasolver){
		};
		 ...
		 *
		 */
		virtual void thetasolver_finalize(GeneralSolver **thetasolver){
		};
		 ...
		 *
		 */
		virtual void gammasolver_updatebeforesolve(GeneralSolver *gammasolver){
		};
		 ...
		 *
		 */
		virtual void thetasolver_updatebeforesolve(GeneralSolver *thetasolver){
		};
		 ...
		 *
		 */
		virtual void gammasolver_updateaftersolve(GeneralSolver *gammasolver){
		};
		 ...
		 *
		 */
		virtual void thetasolver_updateaftersolve(GeneralSolver *thetasolver){
		};
