...
/* subvec1 -= comb */
void operator-=(PetscVectorWrapperSub subvec1, PetscVectorWrapperComb comb)
{
	if(DEBUG_MODE >= 100) std::cout << "(WrapperSub)OPERATOR: subvec -= comb" << std::endl;
...
/* vec1 = vec1./subvec2 */
void operator/=(PetscVectorWrapperSub subvec1, const PetscVectorWrapperSub subvec2)
{
