...
void SPGQPSolver<PetscVector>::solve() {
	...
	Vec Ad_Vec = Ad_p->get_vector();
		...
		externalcontent->cuda_copytogpu(b_Vec);
		externalcontent->cuda_copytogpu(x_Vec);
		externalcontent->cuda_copytogpu(x0_Vec);
		externalcontent->cuda_copytogpu(g_Vec);
		externalcontent->cuda_copytogpu(d_Vec);
		externalcontent->cuda_copytogpu(Ad_Vec);
	#endif
