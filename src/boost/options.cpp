...
void add_options(boost::program_options::options_description *description, int console_nmb_cols){
	...
	boost::program_options::options_description opt_solvers("#### SOLVERS ########################", console_nmb_cols);
		...
		opt_tssolver.add_options()
			...
			("tssolver_gammasolver_updatebeforesolve", boost::program_options::value<bool>(), "call function from model [bool]")
			("tssolver_gammasolver_solve", boost::program_options::value<bool>(), "call function from solver [bool]")
			("tssolver_gammasolver_updateaftersolve", boost::program_options::value<bool>(), "call function from model [bool]")
			("tssolver_thetasolver_updatebeforesolve", boost::program_options::value<bool>(), "call function from model [bool]")
			("tssolver_thetasolver_solve", boost::program_options::value<bool>(), "call function from solver [bool]")
			("tssolver_thetasolver_updateaftersolve", boost::program_options::value<bool>(), "call function from model [bool]")
		...
		opt_entropysolverdlib.add_options()
			...
			("entropysolverdlib_integration_type", boost::program_options::value<int>(), "type of numerical integration [0=AUTO/1=DLIB/2=CUBA/3=CUDAVEGAS]")
		...
		opt_entropysolvernewton.add_options()
			...
			("entropysolvernewton_integration_type", boost::program_options::value<int>(), "type of numerical integration [0=AUTO/1=DLIB/2=CUBA/3=CUDAVEGAS]")
	...
	boost::program_options::options_description opt_models("#### MODELS ########################", console_nmb_cols);
		...
		opt_graphh1femmodel.add_options()
			...
			("graphh1femmodel_matrixtype", boost::program_options::value<int>(), "type of used regularization matrix [0=BlockGraphSparseMatrix/1=BlockGraphSparseTRMatrix]");
	...
	boost::program_options::options_description opt_entropyintegration("#### ENTROPY INTEGRATION ########################", console_nmb_cols);
		...
		opt_entropyintegrationcuba.add_options()
			...
			("entropyintegrationcuba_cubaaccel", boost::program_options::value<int>(), "number of accelerators [int]")
			("entropyintegrationcuba_cubaaccelmax", boost::program_options::value<int>(), "number of threads per accelerator [int]")
		...
		opt_entropyintegrationcudavegas.add_options()
			...
			("entropyintegrationcudavegas_debug_print_integration", boost::program_options::value<bool>(), "print integration results [bool]");
			("entropyintegrationcudavegas_debug_print_integration_inner", boost::program_options::value<bool>(), "print CUDA integration results during iterations [bool]");
