/** @file test_dot.cpp
 *  @brief test the speed of dot product computation with SeqArrayVector
 *
...
int main( int argc, char *argv[] )
{
	...
	opt_problem.add_options()
		("test_filename1", boost::program_options::value< std::string >(), "name of input file with vector1 data (vector in CSV format) [string]")
		("test_filename2", boost::program_options::value< std::string >(), "name of input file with vector2 data (vector in CSV format) [string]")
