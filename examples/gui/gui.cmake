...
option(GUI_SHOW_MOVIE "GUI_SHOW_MOVIE" OFF)
...
printinfo_onoff("   GUI_SHOW_MOVIE                                        (ConsoleArg)                 " "${GUI_SHOW_MOVIE}")
...
if(${GUI_SHOW_MOVIE})
	set(CMAKE_BUILD_TYPE Release)
	testadd_executable("gui/gui_show_movie.cpp" "gui_show_movie")
endif()
