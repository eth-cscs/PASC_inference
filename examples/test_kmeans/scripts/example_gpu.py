...
# times to compute
#Ts = [1000, 5000, 10000, 50000, 100000, 500000, 1000000, 5000000, 10000000, 50000000];
Ts = [1000, 5000];
...
problem_parameters = "--test_K=3 --spgqpsolver_eps=0.00001 --spgqpsolver_stop_Anormgp=false --spgqpsolver_stop_normgp_normb=true --spgqpsolver_debug_mode=3 --tssolver_debug_mode=3 --spgqpsolver_dotfloor=2 --spgqpsolver_m=20 --test_epssqr=1 --test_shortinfo=true --test_savevtk=false --test_savecsv=false";
