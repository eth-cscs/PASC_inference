% import results of denoised "alzheimer" image
%
...
epssqr{1}  = 0.0000001000000000;epssqr_load{1}  = '0.0000001000000000';
...
for i = 1:length(epssqr)
    ...
    name_part = ['test_image_C_noise_medium_w' num2str(width) '_h' num2str(height) '_epssqr' num2str(epssqr_load{i}) '_K' num2str(K) '_arch' arch];

    filename_orig = ['data/image_alzheimer/results/' name_part '_original.bin'];
    filename_rec = ['data/image_alzheimer/results/' name_part '_recovered.bin'];
    filename_gamma = ['data/image_alzheimer/results/' name_part '_gamma.bin'];
