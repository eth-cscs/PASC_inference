...
cput_plot = plot(1:size(cput_times,2), cput_times_relative(1,:), 'g', 'LineWidth', 2.0);
plot(1:size(cput_times,2), cput_times_relative(1,:), 'go', 'LineWidth', 2.0);
...
ax = legend([cpu_plot cput_plot gpu_plot],'CPU 1core','CPU 24cores','GPU');
