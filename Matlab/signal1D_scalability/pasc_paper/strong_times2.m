...
if true
    ...
    subplot(4,2,1)
    plot_me2( 'all', cpu_nmb, cpu_times_all, gpu_nmb, gpu_times_all )
    hold off

    subplot(4,2,2)
    plot_me2( 'projection', cpu_nmb, cpu_times_project, gpu_nmb, gpu_times_project )

    subplot(4,2,3)
    plot_me2( 'matmult', cpu_nmb, cpu_times_matmult, gpu_nmb, gpu_times_matmult )
    
    subplot(4,2,4)
    plot_me2( 'dot', cpu_nmb, cpu_times_dot, gpu_nmb, gpu_times_dot )

    subplot(4,2,5)
    plot_me2( 'update', cpu_nmb, cpu_times_update, gpu_nmb, gpu_times_update )

    subplot(4,2,6)
    plot_me2( 'stepsize', cpu_nmb, cpu_times_stepsize, gpu_nmb, gpu_times_stepsize )

    subplot(4,2,7)
    plot_me2( 'fs', cpu_nmb, cpu_times_fs, gpu_nmb, gpu_times_fs )

    subplot(4,2,8)
    plot_me2( 'other', cpu_nmb, cpu_times_other, gpu_nmb, gpu_times_other )
